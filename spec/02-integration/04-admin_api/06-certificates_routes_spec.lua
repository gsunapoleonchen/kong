    ...
    describe("PUT", function()
      ...
      it("errors on non-distinct certs", function()
        ...
        assert.same({
          code     = Errors.codes.SCHEMA_VIOLATION,
          name     = "schema violation",
          message  = "2 schema violations (values of these fields must be distinct: 'cert', 'cert_alt'; values of these fields must be distinct: 'key', 'key_alt')",
          fields  = {
            ["@entity"] = {
              "values of these fields must be distinct: 'cert', 'cert_alt'",
              "values of these fields must be distinct: 'key', 'key_alt'",
            },
          }
        }, cjson.decode(body))
      end)
